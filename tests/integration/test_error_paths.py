...
@responses.activate
def test_int_03_device_offline_during_start(client, auth_headers, valid_cook_requests):
    """
    ...
    assert "retry_after" in error_data, "Response should include retry_after field"
    assert error_data["retry_after"] > 0, "retry_after should be a positive number of seconds"


@responses.activate
def test_int_04_device_busy_already_cooking(client, auth_headers, valid_cook_requests):
    """
